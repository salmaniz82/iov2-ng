...
angular.module("io2v3",["ui.router","loadingStatus","angularNotify","ngSanitize"]).constant("API_URL","alpha.iskillmetrics.com"==location.hostname?"https://api.iskillmetrics.com/":"http://api.io2v3.dvp/").constant("SITE_URL","alpha.iskillmetrics.com"==location.hostname?"https://alpha.iskillmetrics.com/":"http://localhost:8000/"),angular.module("io2v3").run(["$rootScope","$state","$stateParams","$window","auth","$anchorScroll",function(t,o,a,e,n,l){t.$on("$stateChangeStart",(function(a,e,l,i,s,r){if(null!=t.pooling&&t.pooling.abort(),null!=t.studenExamListPooling&&t.studenExamListPooling.abort(),1==e.authenticate){if(n.hastokenAndUser()||(a.preventDefault(),o.go("logout")),null!=e.roles){var u=n.getUser().role;-1!=e.roles.indexOf(u)||(a.preventDefault(),o.go("logout"))}null!=e.permission&&0==n.userHasPermission(e.permission)&&(a.preventDefault(),o.go("logout"))}})),t.$on("$stateChangeSuccess",(function(a,e,n,l,i){t.pageTitle=o.current.data.pageTitle,console.log(o.current.data.pageTitle)})),t.$on("$stateChangeError",(function(t,o,a,e,n,l){console.log(l)}))}]);
