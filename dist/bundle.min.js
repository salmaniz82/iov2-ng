...
angular.module("io2v3").service("quizPlay",["$http","API_URL",function(t,i){this.prepQuizQuestion=function(u,e){var a=i+"std-quiz-play/quiz_id/"+u+"/attempt_id/"+e;return t.get(a)},this.dlsPrep=function(u,e){var a=i+"std-quiz-play/dls/"+u+"/attempt_id/"+e;return t.get(a)},this.demoQuizData=function(){var u=i+"demoquizplay";return t.get(u)}}]);
...
angular.module("io2v3").controller("alphaDirectAceessCtrl",["API_URL","$scope","$http","$stateParams","auth","$state","SITE_URL","$location",function(t,e,n,a,l,o,s,i){var c=this;null!=a.alphaID&&(c.alphaID=a.alphaID),n.get(t+"quiz-direct-url/"+c.alphaID).then((function(t){if(null!=t.data.urltoken){var e=t.data;c.accesstoken=e.urltoken,c.slug=e.slug,l.isLoggedIn()&&"students"==l.getUser().role&&o.go("inv.invited",{entityslug:c.slug,invitetoken:c.accesstoken})}}),(function(t){})),c.directAcesslogin=function(){var t="/login?actiontoken="+c.accesstoken;console.log(t),i.url(t)}}]);
...
angular.module("io2v3").controller("baseCtrl",["$scope","auth","langSer","API_URL","$state","$http",function(e,t,s,a,o,n){var i=this;i.pageTitle="This is from base",i.isQuizActivated=!1,e.$on("activeQuiz",(function(e,t){i.isQuizActivated=t.status,i.isQuizActivated=t.status})),i.branding="IO2 Version 3",e.baseUrl=a,e.langDropOPen=!1,e.masterData=null,e.lang=s.init(),e.soundObject=null,e.isPlaying=!1,e.entityLogo="assets/images/demo-logo.jpg",t.isLoggedIn()&&t.getUser().role,e.switchLang=function(){e.lang=s.switchLang()},e.langLabel=function(){return"en"==e.lang?"English":"Arabic"},e.langIndex=function(){return s.langIndex()},e.soundWavListCollection=[a+"assets/audio/notify-success.wav",a+"assets/audio/notify-error.wav",a+"assets/audio/notify-info.wav",a+"assets/audio/notify-warning.wav",a+"assets/audio/quiz-next.wav",a+"assets/audio/quiz-prev.wav",a+"assets/audio/quiz-timeout.wav",a+"assets/audio/quiz-end.wav",a+"assets/audio/modal-open.wav"],e.soundWavListCollection.forEach((function(e){})),e.$on("playSound",(function(t,s){e.message=s.message;var o=null;!0===e.isPlaying&&(e.soundObject.pause(),e.soundObject.currentTime=0),"success"===e.message?(o=a+"assets/audio/notify-success.wav",e.soundObject=new Audio,e.soundObject.src=o):"error"===e.message?(o=a+"assets/audio/notify-error.wav",e.soundObject=new Audio,e.soundObject.src=o):"warning"===e.message?(o=a+"assets/audio/notify-warning.wav",e.soundObject=new Audio,e.soundObject.src=o):"info"===e.message?(o=a+"assets/audio/notify-info.wav",e.soundObject=new Audio,e.soundObject.src=o):"modal-open"===e.message?(o=a+"assets/audio/modal-open.wav",e.soundObject=new Audio,e.soundObject.src=o):"quiz-next"===e.message?(o=a+"assets/audio/quiz-next.wav",e.soundObject=new Audio,e.soundObject.src=o):"quiz-prev"===e.message?(o=a+"assets/audio/quiz-prev.wav",e.soundObject=new Audio,e.soundObject.src=o):"quiz-timeout"===e.message?(o=a+"/assets/audio/quiz-timeout.wav",e.soundObject=new Audio,e.soundObject.src=o):"quiz-end"===e.message&&(o=a+"assets/audio/quiz-end.wav",e.soundObject=new Audio,e.soundObject.src=o),e.soundObject.play().then((function(t){e.isPlaying=!0})),e.soundObject.addEventListener("ended",t=>{e.isPlaying=!1})})),i.slugify=function(e){const t="àáäâãåăæąçćčđďèéěėëêęǵḧìíïîįłḿǹńňñòóöôœøṕŕřßśšșťțùúüûǘůűūųẃẍÿýźžż·/_,:;",s=new RegExp(t.split("").join("|"),"g");return e.toString().toLowerCase().replace(/\s+/g,"-").replace(s,e=>"aaaaaaaaacccddeeeeeeeghiiiiilmnnnnooooooprrssssttuuuuuuuuuwxyyzzz------".charAt(t.indexOf(e))).replace(/&/g,"-and-").replace(/[^\w\-]+/g,"").replace(/\-\-+/g,"-").replace(/^-+/,"").replace(/-+$/,"")},i.decodeUrlToken=function(e){var t=decodeURIComponent(e),s=atob(t);return JSON.parse(s)},e.gval={exams:["Exams","الامتحانات","Examens"],about:["About","حول","Sur"],terms:["Terms","شروط","termes"],privacy:["Privacy Policy","سياسة خاصة","Intimité"],url:["url","url","url"],details:["Details","تفاصيل","Détails"],status:["Status","الحالة","Statut"],available:["Available","متوفر","Disponible"],options:["Actions","خيارات","les options"],details:["Details","تفاصيل","détails"],addnew:["Add New","اضف جديد","addnew"],update:["Update","تحديث","Mise à jour"],save:["Save","حفظ","Enregistrer"],cancel:["Cancel","حذف","Annuler"],edit:["Edit","تصحيح","Éditer"],remove:["Remove","حذف","retirer"],delete:["Delete","حذف","Supprimer"],next:["Next","تالي","suivant"],previous:["Previous","السابق","précédent"],back:["Back","الى الخلف","retour"],profile:["Profile","الملف الشخصي","profil"],setting:["Setting","ضبط","réglage"],logout:["Logout","الخروج","Se déconnecter"],login:["Login","تسجيل الدخول","s'identifier"],register:["Register","تسجيل","S'inscrire"],hello:["hello","مرحبا","Bonjour"],dashboard:["Dashboard","لوحة القيادة","Tableau de bord"],questions:["Questions","الأسئلة","Des questions"],quizes:["Quizzes","الإختبارات","Quiz"],quiz:["Quiz","اختبار","Quiz"],stats:["Stats","احصائيات","Statistiques"],roles:["Roles","الأدوار","rôles"],users:["Users","المستخدمين","Utilisateurs"],user:["User","المستعمل","Utilisateur"],myusers:["My Users","بلدي المستخدمين","Mes-utilisateurs"],permissions:["Permissions","أذونات","Autorisations"],rolepermissions:["Role Permissions","أذونات الدور","Autorisations de rôle"],categories:["Categories","التصنيفات","catégories"],medialibraray:["Media Libraray","مكتبة الوسائط","Médiathèque"],modaltest:["Modal Test","اختبار مشروط","Test modal"],activity:["Activity","نشاط","activité"],groups:["Groups","مجموعات","groupes"],overview:["Overview","نظرة عامة","Aperçu"],progress:["Progress","تقدم","Le progrès"],weightDistribution:["Weight Distribution","توزيع الوزن","La répartition du poids"],enroll:["Enroll","يتسجل، يلتحق","Inscrire"],modifyDateTime:["Modify Date/Time","تعديل وقت","Modifier datetime"],title:["Title","عنوان","Titre"],sno:["S.NO","فهرس","Indice"],min:["Min.","الحد الأدنى","le minimum"],max:["Max.","أقصى","Le Maximum"],duration:["Duration","المدة الزمنية","Durée"],filter:["Filter","منقي","Filtre"],filterTitle:["Fitler by title","تصفية حسب العنوان","Filtrer par titre"],email:["Email","البريد الإلكتروني","Email"],name:["Name","اسم","Nom"],changePassword:["Change Password","تغيير كلمة السر","changer le mot de passe"],sendRegistrationEmail:["Send Registration Email","إرسال تسجيل البريد الإلكتروني","Envoyer un e-mail d'inscription"],upload:["Upload","رفع","Télécharger"],autoGenerate:["Auto Generate","توليد السيارات","Génération automatique"],loading:["loading data please wait...","تحميل البيانات يرجى الانتظار","Chargement des données veuillez patienter"],norecords:["No records were found","لم يتم العثور على سجلات","Aucun enregistrement n'a été trouvé"]},e.langDropToggle=function(){e.langDropOPen=!e.langDropOPen},e.changeLanguage=function(t){e.lang=s.changeLanguage(t),e.langDropToggle()},i.updateDashboardLogo=function(){t.isLoggedIn()&&"entity"==t.getUser().role&&n.get(a+"profile-authlogo").then((function(t){var s=t.data.logo;null==t.data.logo&&null==t.data.logo?e.entityLogo="assets/images/demo-logo.jpg":e.entityLogo=a+s}),(function(t){e.entityLogo="assets/images/demo-logo.jpg"}))},i.isLoggedIn=function(){return t.isLoggedIn()},e.getAuthUsername=function(){return i.authUser().name},e.isAdmin=function(){return!!t.isLoggedIn()&&1==i.authUser().role_id},i.authUser=function(){if(this.hastokenAndUser()){var e=localStorage.getItem("hdauEn");return e=atob(e),JSON.parse(e)}},i.hastokenAndUser=function(){return!(!localStorage.hasOwnProperty("auth_token")||!localStorage.hasOwnProperty("hdauEn"))},i.getIndex=function(e,t,s){for(var a=0;a<e.length;a+=1)if(e[a][t]===s)return a;return-1},e.authUser=i.authUser(),i.inboundDecode=function(e){return JSON.parse(decodeURIComponent(atob(e)))},i.outboundEncode=function(e){return encodeURIComponent(window.btoa(e))},e.getUSerRole=function(){return i.authUser().role},i.generatePassword=function(){for(var e="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789",t="",s=0,a=e.length;s<8;++s)t+=e.charAt(Math.floor(Math.random()*a));return t}}]);
...
angular.module("io2v3").controller("examMgmtAbstractCtrl",["API_URL","$scope","$http","$stateParams",function(a,t,s,e){t.absExamId=null,t.masterQuizData=null,t.pageHeading="",this.activateQuizTabNavigation=!0,this.absMessage="this message is from exmabstract",t.$emit("activeQuiz",{status:!0}),t.$parent.base.updateDashboardLogo()}]);
...
angular.module("io2v3").controller("loginCtrl",["$state","auth","API_URL","$scope","$stateParams",function(t,e,n,o,i){e.clearAllhttpCache();var a=this;if(a.loginStatus=null,a.wrongCreds=null,a.actionTokenObj=null,a.interceptDefaultRedirect=!1,null!=i.actiontoken){var l=o.$parent.base.decodeUrlToken(i.actiontoken);"object"==typeof l&&(a.actionTokenObj=l,a.interceptDefaultRedirect=!0,console.log(a.actionTokenObj))}a.handleRedirect=function(){if(e.isLoggedIn()&&e.getUser().role,!localStorage.getItem("auth_token"))return!1;a.interceptDefaultRedirect?"quizInvitation"==a.actionTokenObj.action?t.go("inv.invited",{entityslug:a.actionTokenObj.entitySlug,invitetoken:i.actiontoken}):"directQuiz"==a.actionTokenObj.action?(console.log("navigate to direct quiz"),t.go("inv.invited",{entityslug:a.actionTokenObj.entitySlug,invitetoken:i.actiontoken})):t.go("dash.land"):(t.go("dash.land"),console.log("default no intercept from login redirect"))},a.handleRedirect(),a.login=function(){e.login(a.creds).then(r,c)};var r=function(t){a.loginStatus=!0,a.wrongCreds=!1;var n=null;if(null!=t.data.token){n=t.data.token,localStorage.setItem("auth_token",n);var o=t.data.user,i=JSON.stringify(o);i=btoa(i),localStorage.setItem("hdauEn",i),e.getUser(),a.handleRedirect()}e.getUser()},c=function(t){a.loginStatus=!1,a.wrongCreds=!0;var e={type:"error",title:"Error Heading",content:t.data.message,timeout:3e3};o.$emit("notify",e)}}]);
...
angular.module("io2v3").controller("quizDirectUrlCtrl",["API_URL","$scope","$http","$stateParams","SITE_URL",function(a,e,t,l,r){var i=this;i.examID=l.examID,e.$parent.absExamId=l.examID,e.$parent.exAbs.pageHeading="Direct Url",i.loadProgress=null,i.hasdirectUrl=!1,console.log("quizDirectUrlCtrl activated"),t.get(a+"quiz-alphaid/"+i.examID).then((function(a){if(null!=a.data.alphaID){var e=a.data.alphaID;i.hasdirectUrl=!0,i.quizDirectUrl=r+"d/"+e,console.log("yes it has a token")}}),(function(a){}))}]);
...
angular.module("io2v3").controller("userAgreementCtrl",["API_URL","$scope","$http","$stateParams",function(e,o,t,a){var n=this;console.log("userAgreementCtrl updating for geolocation"),n.ua={},o.ua_stages=1,o.ua_one=1,o.ua_two=null,o.ua_three=null,n.switchInnerState=function(e,t,a){if(1==o.ua_stages&&1==o.ua_one&&!n.ua.agreePolicy){var i={type:"error",title:"Invalid",content:"You must agree to proceed further",timeout:3e3};return o.$emit("notify",i),!1}if(1==o.ua_stages&&1==o.ua_one&&n.ua.agreePolicy)return o[t]=a+1,!1;if(1==o.ua_stages&&2==o.ua_one){var r=!1;if(n.ua.location||(i={type:"warning",title:"Geo Location",content:"You must must agree to allow your geolocation to proceed",timeout:3e3},o.$emit("notify",i),r=!0),n.ua.camera||(i={type:"warning",title:"Camera",content:"You must agree to allow your camera to proceed",timeout:3e3},o.$emit("notify",i),r=!0),n.ua.microphone||(i={type:"warning",title:"Microphone",content:"You must agree to allow your microphone",timeout:3e3},o.$emit("notify",i),r=!0),n.ua.otherPolicies||(i={type:"warning",title:"Other Policies",content:"You must agree to other policies to proceed",timeout:3e3},o.$emit("notify",i),r=!0),r)return r=!1,!1;navigator.permissions.query({name:"geolocation"}).then((function(e){if("granted"!=e.state)return o.$emit("notify",{type:"error",title:"GEOLOCATION",content:"Permission for location was not granted",timeout:3e3}),r=!0,!1;n.hasGeolocation=!0})),navigator.permissions.query({name:"camera"}).then((function(e){if("granted"!=e.state)return o.$emit("notify",{type:"error",title:"CAMERA",content:"Permission for camera was not granted",timeout:3e3}),!1;n.hasCamera=!0})),navigator.permissions.query({name:"microphone"}).then((function(e){if("granted"!=e.state)return o.$emit("notify",{type:"error",title:"MICROPHONE",content:"Permission for Microphone was not granted",timeout:3e3}),!1;n.hasMicrophone=!0})),n.hasGeolocation&&n.hasCamera&&n.hasMicrophone&&(o[t]=a+1)}console.log("parent stage"+o.ua_stages),console.log("child stage"+t),console.log("stage index"+a),2==o.ua_stages&&1==o.ua_two&&(n.hasMicrophone||n.askMicrophonePermission(),n.hasCamera||n.askCameraPermission(),n.hasMicrophone&&n.hasCamera&&(o[t]=a+1)),2==o.ua_stages&&2==o.ua_two&&(o[t]=a+1),3==o.ua_stages&&1==o.ua_three&&(o[t]=a+1),3==o.ua_stages&&2==o.ua_three&&(o[t]=a+1)},n.changeParent=function(e){1==e?o.ua_two=1:2==e&&(o.ua_three=1),o.ua_stages=e+1},n.askGeolocation=function(){n.ua.location&&navigator.geolocation&&navigator.geolocation.getCurrentPosition((function(e){console.log("got the permission"),n.hasGeolocation=!0}),(function(){console.log("failed to get location error")})),console.log("hasGeolocation"+n.hasGeolocation)},n.askMicrophonePermission=function(){n.ua.microphone&&(navigator.getUserMedia||(navigator.getUserMedia=navigator.getUserMedia||navigator.webkitGetUserMedia||navigator.mozGetUserMedia||navigator.msGetUserMedia),navigator.mediaDevices.getUserMedia({audio:!0}).then((function(e){console.log("You let me use your mic!"),n.hasMicrophone=!0})).catch((function(e){console.log("No Microphone pluged in")})))},n.askCameraPermission=function(){n.ua.camera&&(navigator.getUserMedia||(navigator.getUserMedia=navigator.getUserMedia||navigator.webkitGetUserMedia||navigator.mozGetUserMedia||navigator.msGetUserMedia),navigator.mediaDevices.getUserMedia({video:!0}).then((function(e){console.log("You let user your camera"),n.hasCamera=!0})).catch((function(e){console.log("NO camera attached")})))}}]);
