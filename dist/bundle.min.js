...
angular.module("io2v3").controller("examMgmtAbstractCtrl",["API_URL","$scope","$http","$stateParams",function(a,t,s,e){t.absExamId=null,t.masterQuizData=null,t.pageHeading="",this.activateQuizTabNavigation=!0,this.absMessage="this message is from exmabstract",t.$parent.base.updateDashboardLogo()}]);
