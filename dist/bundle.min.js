...
angular.module("io2v3").controller("demoQuizCtrl",["API_URL","$scope","$http","$stateParams",function(o,e,l,t){console.log("demo quiz will be here ...")}]);
