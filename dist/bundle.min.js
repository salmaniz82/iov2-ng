...
angular.module("io2v3",["ui.router","loadingStatus","angularNotify","ngSanitize"]).constant("API_URL","alpha.iskillmetrics.com"==location.hostname?"https://api.iskillmetrics.com/":"http://api.io2v3.dvp/").constant("SITE_URL","alpha.iskillmetrics.com"==location.hostname?"https://alpha.iskillmetrics.com/":"http://localhost:8000/"),angular.module("io2v3").run(["$rootScope","$state","$stateParams","$window","auth","$anchorScroll",function(o,t,n,a,e,l){o.$on("$stateChangeStart",(function(n,a,l,i,s,r){if(null!=o.pooling&&o.pooling.abort(),null!=o.studenExamListPooling&&o.studenExamListPooling.abort(),1==a.authenticate){if(e.hastokenAndUser()||(n.preventDefault(),t.go("logout")),null!=a.roles){var u=e.getUser().role;-1!=a.roles.indexOf(u)||(n.preventDefault(),t.go("logout"))}null!=a.permission&&0==e.userHasPermission(a.permission)&&(n.preventDefault(),t.go("logout"))}})),o.$on("$stateChangeSuccess",(function(o,t,n,a,e){})),o.$on("$stateChangeError",(function(o,t,n,a,e,l){console.log(l)}))}]);
...
!function(){function t(t,e,a){a.html5Mode({enabled:!0,requireBase:!0}),e.otherwise("notfound"),t.state("pub",{templateUrl:"views/templates/publicTemplate.html",abstract:!0}).state("pub.home",{url:"/",templateUrl:"views/home.html",controller:"homeCtrl"}).state("pub.about",{url:"/about",templateUrl:"views/about.html"}).state("pub.tos",{url:"/term-service",templateUrl:"views/terms-service.html"}).state("pub.pp",{url:"/privacy-policy",templateUrl:"views/privacy-policy.html"}).state("exm",{abstract:!0,templateUrl:"views/templates/tab.exam.layout.html",controller:"examMgmtAbstractCtrl as exAbs"}).state("exm.exam",{url:"/exam-overview/:examID",templateUrl:"views/exams/exam-overview.html",controller:"examOverviewCtrl as vm"}).state("exm.quizQuestions",{url:"/quiz-questions/:examID",templateUrl:"views/exams/quiz-questions.html",controller:"quizQuestionsCtrl as vm"}).state("exm.addQuizQuestions",{url:"/add-quiz-questions/:examID",templateUrl:"views/dash/que-add.html",controller:"queAddCtrl as vm",resolve:{queGlobalData:["quizDataService",function(t){return t.queGlobalFetch()}]}}).state("exm.quizOverview",{url:"/exam-quiz-overview",templateUrl:"views/exams/quiz-attempt-overview.html"}).state("exm.enroll",{url:"/exam-enroll/:examID",templateUrl:"views/exams/exam-enroll.html",controller:"enrollCtrl as vm"}).state("exm.register",{url:"/exam-register/:examID",templateUrl:"views/exams/exam-register.html",controller:"registerEnrollCtrl as vm"}).state("exm.progress",{url:"/exam-progress/:examID",templateUrl:"views/exams/exam-progress.html",controller:"quizProgressCtrl as vm"}).state("exm.prog-detail",{url:"/exam-progress-detail",templateUrl:"views/exams/exam-progress-detail.html"}).state("exm.answer",{url:"/exams/answer/:examID/:attemptID",templateUrl:"views/exams/answer-sheet.html",controller:"quizAnswerInpectCtrl as vm"}).state("exm.consent",{url:"/exams/consent/:examID/:attemptID",templateUrl:"views/exams/consent.html",controller:"quizAnswerConsentCtrl as vm"}).state("exm.scorecard",{url:"/exams/scorecard/:examID/:attemptID",templateUrl:"views/exams/scorecard.html",controller:"quizScoreCardCtrl as vm"}).state("exm.quizWeightDistro",{url:"/quiz-weight-distro/:examID",templateUrl:"views/exams/quiz-weight-distro.html",controller:"quizWeightDistroCtrl as vm"}).state("exm.quizEvaluate",{url:"/quiz-evaluate",templateUrl:"views/exams/quiz-evaluate.html"}).state("exm.notify",{url:"/notify",templateUrl:"views/notify.html",controller:"notifyCtrl as vm"}).state("dash",{templateUrl:"views/templates/tab.layout.html",controller:"dashboardCtrl as dash",abstract:!0}).state("dash.land",{url:"/dashboard",templateUrl:"views/dash-landing.html",controller:"dashLandCtrl as vm",authenticate:!0}).state("dash.profile",{url:"/profile",templateUrl:"views/dash/profile.html",controller:"dashProfileCtrl as vm"}).state("std.profile",{url:"/account-details",template:"<h2>Profile Settings are not avaialable</h2>"}).state("dash.admindashboard",{url:"/dashboard",template:"<h1>Admin dashboard is under  contruction please login with : abf@domain.com to view entity dashboard</h1>"}).state("dash.entityDashbaord",{url:"/dashboard",templateUrl:"views/dashboard-entity.html",controller:"dashboardEntityCtrl as vm",authenticate:!0,roles:["entity"]}).state("dash.contributorDashbaord",{url:"/dashboard",template:"<h2>Contributor dashboard is under construction</h2>",authenticate:!0,roles:["contributor"]}).state("dash.contDevDashbaord",{url:"/dashboard",template:"<h2> Content Developer Dashboard is under construction </h2>",authenticate:!0,roles:["content developer"]}).state("std.studentDashbaord",{url:"/dashboard",template:"<h2> Dashboard settings for candiates are not yet not available. </h2>",controller:"studentDashboardCtrl as vm",authenticate:!0,roles:["students","candidate"]}).state("dash.quizzes",{url:"/quizzes",templateUrl:"views/dash/dash-quizzes.html",controller:"dashQuizzesCtrl as vm",authenticate:!0,roles:["admin","entity","invigilator"]}).state("dash.cats",{url:"/categories",templateUrl:"views/dash/categories.html",controller:"categoriesCtrl as vm",authenticate:!0,roles:["admin","content developer"]}).state("dash.catree",{url:"/cat-tree",templateUrl:"views/dash/cat-tree.html",controller:"catTreeCtrl as vm"}).state("dash.quePool",{url:"/que-pool",templateUrl:"views/dash/que-pool.html",controller:"quepoolCtrl as vm"}).state("dash.questions",{url:"/questions",templateUrl:"views/dash/questions.html",controller:"questionsCtrl as vm",authenticate:!0,roles:["admin","content developer","contributor","entity"]}).state("dash.queadd",{url:"/question-add",templateUrl:"views/dash/que-add.html",controller:"queAddCtrl as vm",resolve:{queGlobalData:["quizDataService",function(t){return t.queGlobalFetch()}]}}).state("dash.queupload",{url:"/question-upload",templateUrl:"views/dash/questions-upload.html",controller:"questionUploadCtrl as vm",resolve:{queGlobalData:["quizDataService",function(t){return t.queGlobalFetch()}]}}).state("dash.questionedit",{url:"/question-edit/:queID",templateUrl:"views/dash/que-edit.html",controller:"questionEditCtrl as vm",resolve:{queGlobalData:["quizDataService",function(t){return t.queGlobalFetch()}]},authenticate:!0,roles:["admin","entity","contributor","content developer"]}).state("dash.users",{url:"/users",templateUrl:"views/dash/users.html",controller:"usersCtrl as vm",authenticate:!0,roles:["admin"]}).state("dash.myusers",{url:"/my-users",templateUrl:"views/dash/my-users.html",controller:"myusersCtrl as vm",authenticate:!0,roles:["entity"]}).state("dash.roles",{url:"/roles",templateUrl:"views/dash/roles.html",controller:"rolesCtrl as vm",authenticate:!0,roles:["admin"]}).state("dash.permission",{url:"/permissions",templateUrl:"views/dash/permissions.html",controller:"permissionsCtrl as vm",authenticate:!0,roles:["admin"]}).state("dash.rolePermissions",{url:"/role-permissions",templateUrl:"views/dash/role-permissions.html",controller:"rolePermissionsCtrl as vm",authenticate:!0,roles:["admin"]}).state("dash.library",{url:"/library",templateUrl:"views/dash/library.html",controller:"libraryCtrl as vm",authenticate:!0,roles:["admin"]}).state("dash.modal",{url:"/modal",templateUrl:"views/modal.html",controller:"modalCtrl as vm"}).state("dash.batches",{url:"/groups",templateUrl:"views/dash/batches.html",controller:"batchesCtrl as vm",authenticate:!0,permission:["batch-list"]}).state("ua",{abstract:!0,template:"<ui-view/>"}).state("ua.login",{url:"/login?actiontoken&redirectUrl",templateUrl:"views/login.html",controller:"loginCtrl as vm"}).state("ua.register",{url:"/register",templateUrl:"views/register.html",controller:"registerCtrl as vm"}).state("ua.forget",{url:"/forget",controller:"forgetCtrl as vm",templateUrl:"views/forget.html"}).state("ua.recovery",{url:"/recover?accesstoken",controller:"recoverCtrl as vm",templateUrl:"views/recover.html"}).state("logout",{url:"/logout",controller:"logoutCtrl as vm"}).state("onExamRefresh",{url:"/examrefreshed/:attempt_id/:quiz_id",templateUrl:"views/student/onexamrefresh.html",controller:"examRefreshedCtrl as vm"}).state("quizcomplited",{url:"/quizcomplited",templateUrl:"views/student/quizcomplited.html",controller:"quizcomplitedCtrl as vm"}).state("std",{templateUrl:"views/templates/tab.student.layout.html",controller:"stdCtrl as std",abstract:!0}).state("std.exams",{url:"/stexams",templateUrl:"views/student/exams.html",controller:"stdExamCtrl as vm"}).state("std.quiz",{url:"/quiz",controller:"stdQuizCtrl as vm",templateUrl:"views/student/quiz.html"}).state("quizPlay",{url:"/quiz-assement/:attempt_id/:quiz_id",templateUrl:"views/student/quiz-play.html",controller:"quizAttemptCtrl as vm",resolve:{quizPlayData:["quizPlay","$stateParams",function(t,e){var a=e.attempt_id,l=e.quiz_id;return t.prepQuizQuestion(l,a)}]},authenticate:!0,roles:["students","student","candidate"]}).state("quizPlayDLS",{url:"/quiz-assessment/dls/:attempt_id/:quiz_id",templateUrl:"views/student/dynamic-quiz.html",controller:"quizDlsCtrl as vm",resolve:{quizPlayData:function(t,e){var a=e.attempt_id,l=e.quiz_id;return t.dlsPrep(l,a)}},authenticate:!0,roles:["students","student","candidate"]}).state("questionPreview",{url:"/questionpreview/:questionId",templateUrl:"views/question-preview.html",controller:"questionPreviewCtrl as vm"}).state("inv",{templateUrl:"views/templates/inv.invited.html",abstract:!0,controller:"invitedAbstractCtrl as vm"}).state("inv.invited",{url:"/i/:entityslug/:invitetoken",templateUrl:"views/student/invited.html",controller:"invitedbyentityCtrl as vm"}).state("dash.quizWizard",{url:"/new-quiz-wizard",templateUrl:"views/new-quiz-wizard.html",controller:"newQuizWizardCtrl as vm",resolve:{wizardPreset:["quizWizardService",function(t){return t.getPresetValues()}]}}).state("message",{url:"/message",templateUrl:"views/message.html",controller:"messageCtrl as vm"}).state("quizui",{url:"/quizui",templateUrl:"views/student/quizui.html"}).state("mob",{templateUrl:"views/templates/tab.mobile.layout.html",controller:"mobileAbstractCtrl as vm",abstract:!0}).state("mob.activity",{url:"/activity",templateUrl:"views/mobile/activity.html",controller:"mobileActivityCtrl as vm",authenticate:!0,permission:"activity-monitor"}).state("notfound",{url:"/notfound",templateUrl:"views/404.html"})}angular.module("io2v3").config(t),t.$inject=["$stateProvider","$urlRouterProvider","$locationProvider"]}();
...
angular.module("io2v3").controller("baseCtrl",["$scope","auth","langSer","API_URL","$state","$http",function(e,t,o,s,n,a){var i=this;i.branding="IO2 Version 3",e.baseUrl=s,e.langDropOPen=!1,e.masterData=null,e.lang=o.init(),e.soundObject=null,e.isPlaying=!1,e.entityLogo="assets/images/demo-logo.jpg",e.switchLang=function(){e.lang=o.switchLang()},e.langLabel=function(){return"en"==e.lang?"English":"Arabic"},e.langIndex=function(){return o.langIndex()},e.soundWavListCollection=[s+"assets/audio/notify-success.wav",s+"assets/audio/notify-error.wav",s+"assets/audio/notify-info.wav",s+"assets/audio/notify-warning.wav",s+"assets/audio/quiz-next.wav",s+"assets/audio/quiz-prev.wav",s+"assets/audio/quiz-timeout.wav",s+"assets/audio/quiz-end.wav",s+"assets/audio/modal-open.wav"],e.soundWavListCollection.forEach((function(e){})),e.$on("playSound",(function(t,o){e.message=o.message;var n=null;!0===e.isPlaying&&(console.log("stop previous audio"),e.soundObject.pause(),e.soundObject.currentTime=0),"success"===e.message?(n=s+"assets/audio/notify-success.wav",e.soundObject=new Audio,e.soundObject.src=n):"error"===e.message?(n=s+"assets/audio/notify-error.wav",e.soundObject=new Audio,e.soundObject.src=n):"warning"===e.message?(n=s+"assets/audio/notify-warning.wav",e.soundObject=new Audio,e.soundObject.src=n):"info"===e.message?(n=s+"assets/audio/notify-info.wav",e.soundObject=new Audio,e.soundObject.src=n):"modal-open"===e.message?(n=s+"assets/audio/modal-open.wav",e.soundObject=new Audio,e.soundObject.src=n):"quiz-next"===e.message?(n=s+"assets/audio/quiz-next.wav",e.soundObject=new Audio,e.soundObject.src=n):"quiz-prev"===e.message?(n=s+"assets/audio/quiz-prev.wav",e.soundObject=new Audio,e.soundObject.src=n):"quiz-timeout"===e.message?(n=s+"/assets/audio/quiz-timeout.wav",e.soundObject=new Audio,e.soundObject.src=n):"quiz-end"===e.message&&(n=s+"assets/audio/quiz-end.wav",e.soundObject=new Audio,e.soundObject.src=n),console.log(e.message),e.soundObject.play().then((function(t){console.log(e.soundObject),e.isPlaying=!0})),e.soundObject.addEventListener("ended",t=>{e.isPlaying=!1})})),i.slugify=function(e){const t="àáäâãåăæąçćčđďèéěėëêęǵḧìíïîįłḿǹńňñòóöôœøṕŕřßśšșťțùúüûǘůűūųẃẍÿýźžż·/_,:;",o=new RegExp(t.split("").join("|"),"g");return e.toString().toLowerCase().replace(/\s+/g,"-").replace(o,e=>"aaaaaaaaacccddeeeeeeeghiiiiilmnnnnooooooprrssssttuuuuuuuuuwxyyzzz------".charAt(t.indexOf(e))).replace(/&/g,"-and-").replace(/[^\w\-]+/g,"").replace(/\-\-+/g,"-").replace(/^-+/,"").replace(/-+$/,"")},i.decodeUrlToken=function(e){var t=decodeURIComponent(e),o=atob(t);return JSON.parse(o)},e.gval={exams:["Exams","الامتحانات","Examens"],about:["About","حول","Sur"],terms:["Terms","شروط","termes"],privacy:["Privacy Policy","سياسة خاصة","Intimité"],details:["Details","تفاصيل","Détails"],status:["Status","الحالة","Statut"],available:["Available","متوفر","Disponible"],options:["Actions","خيارات","les options"],details:["Details","تفاصيل","détails"],addnew:["Add New","اضف جديد","addnew"],update:["Update","تحديث","Mise à jour"],save:["Save","حفظ","Enregistrer"],cancel:["Cancel","حذف","Annuler"],edit:["Edit","تصحيح","Éditer"],remove:["Remove","حذف","retirer"],delete:["Delete","حذف","Supprimer"],next:["Next","تالي","suivant"],previous:["Previous","السابق","précédent"],back:["Back","الى الخلف","retour"],profile:["Profile","الملف الشخصي","profil"],setting:["Setting","ضبط","réglage"],logout:["Logout","الخروج","Se déconnecter"],login:["Login","تسجيل الدخول","s'identifier"],register:["Register","تسجيل","S'inscrire"],hello:["hello","مرحبا","Bonjour"],dashboard:["Dashboard","لوحة القيادة","Tableau de bord"],questions:["Questions","الأسئلة","Des questions"],quizes:["Quizzes","الإختبارات","Quiz"],quiz:["Quiz","اختبار","Quiz"],stats:["Stats","احصائيات","Statistiques"],roles:["Roles","الأدوار","rôles"],users:["Users","المستخدمين","Utilisateurs"],user:["User","المستعمل","Utilisateur"],myusers:["My Users","بلدي المستخدمين","Mes-utilisateurs"],permissions:["Permissions","أذونات","Autorisations"],rolepermissions:["Role Permissions","أذونات الدور","Autorisations de rôle"],categories:["Categories","التصنيفات","catégories"],medialibraray:["Media Libraray","مكتبة الوسائط","Médiathèque"],modaltest:["Modal Test","اختبار مشروط","Test modal"],activity:["Activity","نشاط","activité"],groups:["Groups","مجموعات","groupes"],overview:["Overview","نظرة عامة","Aperçu"],progress:["Progress","تقدم","Le progrès"],weightDistribution:["Weight Distribution","توزيع الوزن","La répartition du poids"],enroll:["Enroll","يتسجل، يلتحق","Inscrire"],modifyDateTime:["Modify Date/Time","تعديل وقت","Modifier datetime"],title:["Title","عنوان","Titre"],sno:["S.NO","فهرس","Indice"],min:["Min.","الحد الأدنى","le minimum"],max:["Max.","أقصى","Le Maximum"],duration:["Duration","المدة الزمنية","Durée"],filter:["Filter","منقي","Filtre"],filterTitle:["Fitler by title","تصفية حسب العنوان","Filtrer par titre"],email:["Email","البريد الإلكتروني","Email"],name:["Name","اسم","Nom"],changePassword:["Change Password","تغيير كلمة السر","changer le mot de passe"],sendRegistrationEmail:["Send Registration Email","إرسال تسجيل البريد الإلكتروني","Envoyer un e-mail d'inscription"],upload:["Upload","رفع","Télécharger"],autoGenerate:["Auto Generate","توليد السيارات","Génération automatique"],loading:["loading data please wait...","تحميل البيانات يرجى الانتظار","Chargement des données veuillez patienter"],norecords:["No records were found","لم يتم العثور على سجلات","Aucun enregistrement n'a été trouvé"]},console.log("updated with lang drop"),e.langDropToggle=function(){e.langDropOPen=!e.langDropOPen},e.changeLanguage=function(t){e.lang=o.changeLanguage(t),e.langDropToggle()},i.updateDashboardLogo=function(){t.isLoggedIn()&&"entity"==t.getUser().role&&a.get(s+"profile-authlogo").then((function(t){var o=t.data.logo;null==t.data.logo&&null==t.data.logo?e.entityLogo="assets/images/demo-logo.jpg":e.entityLogo=s+o}),(function(t){e.entityLogo="assets/images/demo-logo.jpg"}))},i.isLoggedIn=function(){return t.isLoggedIn()},e.getAuthUsername=function(){return i.authUser().name},e.isAdmin=function(){return!!t.isLoggedIn()&&1==i.authUser().role_id},i.authUser=function(){if(this.hastokenAndUser()){var e=localStorage.getItem("hdauEn");return e=atob(e),JSON.parse(e)}},i.hastokenAndUser=function(){return!(!localStorage.hasOwnProperty("auth_token")||!localStorage.hasOwnProperty("hdauEn"))},i.getIndex=function(e,t,o){for(var s=0;s<e.length;s+=1)if(e[s][t]===o)return s;return-1},e.authUser=i.authUser(),i.inboundDecode=function(e){return JSON.parse(decodeURIComponent(atob(e)))},i.outboundEncode=function(e){return encodeURIComponent(window.btoa(e))},e.getUSerRole=function(){return i.authUser().role},i.generatePassword=function(){for(var e="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789",t="",o=0,s=e.length;o<8;++o)t+=e.charAt(Math.floor(Math.random()*s));return t}}]);
angular.module("io2v3").controller("batchesCtrl",["API_URL","$scope","$http","$state",function(t,a,e,n){var i=this;a.$parent.base.pageUrl=n.current.url,a.$parent.dash.pageHeading="Batches",i.revealQuizList=!1,i.loadingStatus=null,i.showProgress=!1,i.revealCandProgress=!1,i.showEnrollment=!1,i.showBatchDetails=!1,i.getEligQuiz=function(){e.get(t+"batches/elig/quiz").then((function(t){i.eligQuiz=t.data.eligQuiz,i.revealQuizList=!0}),(function(t){var e={type:"error",title:"Error While Fetching Eligible Quiz",content:t.data.message,timeout:5e3};a.$emit("notify",e),i.revealQuizList=!1}))},i.enrollProcess=function(){console.log(i.nbt.email),i.activeBatchId,e({url:t+"batches/enrollprocess/"+i.activeBatchId,method:"POST",data:{email:i.nbt.email}}).then((function(t){i.nbt.email="",null==i.enrollCanidateList?(i.enrollCanidateList=t.data.lastCandiate,i.enrollContents=!0):i.enrollCanidateList.push(t.data.lastCandiate[0]);var e={type:"success",title:"Batch Enrollment",content:t.data.message,timeout:8e3};a.$emit("notify",e)}),(function(t){var e={type:"error",title:"Failed Batch Enrollment",content:t.data.message,timeout:8e3};a.$emit("notify",e)}))},i.triggerEnroll=function(a){i.showEnrollment=!0,i.activeBatchId=a,e.get(t+"batches/tagged/canidates/"+a).then((function(t){206==t.status?i.enrollContents=!1:200==t.status&&(i.enrollContents=!0,i.enrollCanidateList=t.data.candidates)}),(function(t){}))},i.closeCandProgress=function(){i.revealCandProgress=!1,i.progressData=i.lastBatchProgress,i.showProgress=!0},i.nb={},i.batchQuizList=[],e({url:t+"batches",method:"GET",cache:!1}).then((function(t){i.dataList=t.data,i.loadingStatus=!0}),(function(t){i.loadingStatus=!1})),i.enableQuizSelect=function(){i.getEligQuiz()},i.addtoBatch=function(t){var e=a.$parent.base.getIndex(i.eligQuiz,"id",t),n=i.eligQuiz[e];i.batchQuizList.push(n),i.calcMinMax()},i.unlinkQuizFromBatch=function(t){var e=a.$parent.base.getIndex(i.batchQuizList,"id",t);i.batchQuizList.splice(e,1),i.calcMinMax()},i.hasItemAdded=function(t){return-1!=a.$parent.base.getIndex(i.batchQuizList,"id",t)},i.calcMinMax=function(){var t=0,a=0;for(var e in i.batchQuizList)i.batchQuizList.hasOwnProperty(e)&&(t+=parseInt(i.batchQuizList[e].maxScore),a+=parseInt(i.batchQuizList[e].minScore));i.nb.minScore=a,i.nb.maxScore=t},i.addBatchProcess=function(){var a={title:i.nb.title,maxScore:i.nb.maxScore,passingScore:i.nb.minScore,quizIds:function(){var t=[];for(var a in i.batchQuizList)i.batchQuizList.hasOwnProperty(a)&&t.push(i.batchQuizList[a].id);return t}()};console.log(a),e({method:"POST",url:t+"batches",data:a}).then((function(t){i.revealQuizList=!1,i.addBatch=!1,i.nb={},i.batchQuizList=[],i.nb.minScore=0,i.nb.maxScore=0,null==i.dataList?(i.loadingStatus=!0,i.dataList={},i.dataList.batches=t.data.lastBatch):i.dataList.batches.push(t.data.lastBatch[0])}),(function(t){console.log(t)}))},i.activateProgress=function(a){i.activeBatchId=a,i.addBatch=!1,e.get(t+"batches/"+a).then((function(t){i.showProgress=!0,i.progressData=t.data.batchProgress}),(function(t){}))},i.closeProgress=function(){i.showProgress=!1,i.progressData=null,i.activeBatchId=null},i.closeEnroll=function(){i.showEnrollment=!1,i.activeBatchId=null},i.activateCanidateProgress=function(a){i.lastBatchProgress=i.progressData,e.get(t+"batches/candidate/overview/"+i.activeBatchId+"/"+a).then((function(t){i.candProgress=t.data.batchCanidateOverview,i.candSummary=t.data.summary,i.showProgress=!1,i.revealCandProgress=!0}),(function(t){}))},i.activateDetails=function(n){i.activeBatchId=n,e.get(t+"batch/details/"+n).then((function(t){i.batchMasterDetails=t.data,i.showBatchDetails=!0,console.log(t.data),i.proceedToX=!1}),(function(t){var e={type:"error",title:"Not Found",content:t.data.message,timeout:5e3};a.$emit("notify",e),i.closeBatchDetails()}))},i.closeBatchDetails=function(){i.activeBatchId=null,i.showBatchDetails=!1,i.proceedToX=!1}}]);
...
angular.module("io2v3").controller("stdExamCtrl",["API_URL","SITE_URL","$scope","$http","$state","$interval","xToTimeFilter","$rootScope",function(t,e,a,i,o,n,s,l){var u=this;function d(t){0!=t.data.quiz&&(u.hasQuizEnrolled=!0,u.hasPendingQuiz=!0),0!=t.data.attempted&&(u.hasAttemptedQuiz=!0,u.hasQuizEnrolled=!0),0==t.data.quiz&&0==t.data.attempted&&(u.hasQuizEnrolled=!1),u.dataList=t.data}function r(t){0==t.data.quiz&&0==t.data.attempted&&(u.hasQuizEnrolled=!1)}u.quizModal=!1,u.hasQuizEnrolled=null,u.hasPendingQuiz=!1,u.hasAttemptedQuiz=!1,u.isInitiatStart=!1,u.detailModalBox=!1,u.progressDetailsModal=!1,u.poolCounter=0,a.counter=[],a.$parent.std.pageHeading="Quiz",localStorage.removeItem("lastStoredDurationSeconds"),u.initiateQuiz=function(o){u.isInitiatStart=!0,i({url:t+"std-quiz-initiate",method:"POST",data:{enroll_id:o}}).then((function(t){var i=t.data;if(0!=i.usedXTimes){u.quizModal=!1;var o={type:"error",title:"Error",content:i.warning_message,timeout:8e3};return a.$emit("notify",o),!1}if("static"==i.type){s=t.data.attempt_id,u.actQuiz.id;var n=e+"quiz-assement/"+s+"/"+u.actQuiz.id;u.quizModal=!1,u.isInitiatStart=!1,u.actQuiz.validity="progress",window.quizWindow=window.open(n,"Quiz","toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=0,fullscreen=yes,width="+screen.availWidth+",height="+screen.availHeight)}else if("dls"==i.type){var s;s=t.data.attempt_id,u.actQuiz.id,dlsPopupUrl=e+"/quiz-assessment/dls/"+s+"/"+u.actQuiz.id,u.quizModal=!1,u.isInitiatStart=!1,u.actQuiz.validity="progress",window.quizWindow=window.open(dlsPopupUrl,"Quiz","toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=0,fullscreen=yes,width="+screen.availWidth+",height="+screen.availHeight)}else console.log("quiz type is unknown")}),(function(t){console.log(t)}))},u.launchQuizModal=function(t,e=!1){if(e)i=a.$parent.base.getIndex(u.dataList.attempted,"id",t),u.actQuiz=u.dataList.attempted[i];else{var i=a.$parent.base.getIndex(u.dataList.quiz,"id",t);u.actQuiz=u.dataList.quiz[i]}u.quizModal=!0},u.fetchQuizListings=function(){i({url:t+"std-quiz-list",method:"GET"}).then(d,r)},u.fetchQuizListings(),u.showCountdown=function(t,e,i){new Date(e).getTime();var o=new Date(i).getTime(),s=(new Date).getTime();if(o>s){console.log("work for countdown");var l=n((function(){var e=(new Date).getTime(),i=o-e,s=Math.floor(i/864e5),d=Math.floor(i%864e5/36e5),r=Math.floor(i%36e5/6e4),c=Math.floor(i%6e4/1e3);if(i<=0){n.cancel(l);var z=a.$parent.base.getIndex(u.dataList.quiz,"id",t);u.dataList.quiz[z].schedule="eligible"}a.counter[t]=0==s&&0==d?r+" mins "+c+" secs ":s+" DD "+d+" HH "+r+" mm "+c+" ss ",console.log(i)}),1e3)}},u.updateOnFinish=function(e){var i={timestamp:e||null};l.studenExamListPooling=$.ajax({type:"GET",url:t+"std-quiz-polling",data:i,headers:{token:localStorage.auth_token},success:function(t){t.timestamp>0&&(u.poolCounter+=1),u.poolCounter>1&&(console.log("update the list"),u.fetchQuizListings(),console.log(t)),a.$apply(),u.updateOnFinish(t.timestamp)}})},u.updateOnFinish(null),u.activateDetails=function(t,e){u.fetchQuizDetails(t)},u.deactivateDetail=function(){u.detailModalBox=!1},u.fetchQuizDetails=function(e){i({url:t+"quiz/"+e,method:"GET"}).then((function(t){1==t.data.status&&(u.detailModalBox=!0,u.modalQuiz=t.data.quiz[0])}),(function(t){}))},u.activateProgressStatus=function(e){console.log(e),i({url:t+"std-self-progress/"+e,method:"GET"}).then((function(t){1==t.data.status&&(u.mdProgressData=t.data.progress[0],u.progressDetailsModal=!0)}),(function(t){}))},u.deActicateProgressStatus=function(){u.progressDetailsModal=!1}}]);
angular.module("io2v3").controller("stdQuizCtrl",["API_URL","$scope","$timeout",function(o,e,t){e.pageHeading=""}]);
angular.module("io2v3").controller("studentDashboardCtrl",["API_URL","$scope","$http","$stateParams",function(e,o,t,n){o.$parent.std.pageHeading="Main",console.log("protected console"),setTimeout((function(){$(document).keydown((function(e){return 123!=e.keyCode&&85!=e.keyCode&&!(e.ctrlKey&&e.shiftKey&&73==e.keyCode||85==e.keyCode)&&void 0})),$("body").bind("cut copy paste",(function(e){console.log(e),e.preventDefault()}))}))}]);
