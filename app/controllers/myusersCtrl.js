    ...
    angular.module('io2v3').controller('myusersCtrl', ['API_URL', '$scope', '$http', '$state', 'auth', function(API_URL, $scope, $http, $state, auth){
        ...
        vm.processUserUPload = function()
        {
            ...
            var successUserUpload = function(res) {
                ...
                if(res.data.addedUsers != undefined && res.data.addedUsers.length !=0)
                {

                    vm.newGernatedUsers = res.data.addedUsers;

                    angular.forEach(vm.newGernatedUsers, function(user, key) {
        ...
        vm.userAutoGenerate = function()
        {

            
            var Url = API_URL+'users-autogenerate';


            var successGenerate = function(res)
            {

                vm.autoGeneratedStatus = true;

                vm.addUser = false;

                vm.generatedUsersList = res.data.infoPayload;
            ...
            var errorGenerate = function(res)
            {
            ...
            $http({
                ...
                method : 'POST',
                data : {}
            }).then(successGenerate, errorGenerate)


        };


        vm.deactivateInfoGenerated = function()
        {
            ...
            vm.generatedUsersList = undefined;
